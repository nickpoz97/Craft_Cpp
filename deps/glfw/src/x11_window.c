                              ...
                              const _GLFWwndconfig* wndconfig)
{
    ...
    _glfwPlatformGetWindowPos(window, &window->x11.xpos, &window->x11.scroll_pos);
    ...
    switch (event->type)
    {
        ...
        case ConfigureNotify:
        {
            ...
            if (event->xconfigure.x != window->x11.xpos ||
                event->xconfigure.y != window->x11.scroll_pos)
            {
                ...
                window->x11.scroll_pos = event->xconfigure.y;
            }
