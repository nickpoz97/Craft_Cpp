...
Character::Character(const glm::vec2 &position, float m, float n, char c)
  ...
  vertices = {{{{position + glm::vec2{-n, -m}}, glm::vec2{du, dv}},
...
int Character::getNVertices() { return nVertices; }

decltype(Character::vertices.begin()) Character::begin() {
  return vertices.begin();
}

decltype(Character::vertices.end()) Character::end() { return vertices.end(); }
