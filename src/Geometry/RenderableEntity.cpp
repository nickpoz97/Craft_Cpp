...
template <typename VertexType>
RenderableEntity<VertexType>::RenderableEntity(
    const std::vector<VertexType> &local_buffer)
    : RenderableEntity{} {
...
template <typename VertexType>
void RenderableEntity<VertexType>::updateBuffer(
    const std::vector<VertexType> &local_buffer) const {
  gpu_buffer.storeData(local_buffer);
}

template <typename VertexType>
RenderableEntity<VertexType>::RenderableEntity(
    RenderableEntity &&other) noexcept
...
template class RenderableEntity<BlockVertex>;
